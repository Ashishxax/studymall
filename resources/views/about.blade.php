...
<main id="main">
  ...
  <section id="team" class="team">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" style="margin-left: 407px;">
          <div class="member">
        ...
        {{-- <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
          <div class="member">
            <img src="assets/img/team/kkroy.png" style="margin-top: -88px;" alt="">
            <h4>K.K. Roy (Delhi)</h4>
            <span>Maths Department</span>
            <p>
